...
$pass = $is->getPassword();
$dir = "test/".$pass[$_SESSION['turn'] % count($pass)];
$files = scandir($dir, 1);
$keyimg = $dir."/".$files[$_SESSION['turn'] % count($files)];
...
<body>
	...
	<table>
	<tr>
	<td><a href="?selected=1" onClick="select(1)"><img class="img_cell" src="<?php echo ($correct_cell==1)?$keyimg:$dummy[0]; ?>" /></a></td>
	<td><a href="?selected=2" onClick="select(2)"><img class="img_cell" src="<?php echo ($correct_cell==2)?$keyimg:$dummy[1]; ?>" /></a></td>
	<td><a href="?selected=3" onClick="select(3)"><img class="img_cell" src="<?php echo ($correct_cell==3)?$keyimg:$dummy[2]; ?>" /></a></td>
	</tr>
	<tr>
